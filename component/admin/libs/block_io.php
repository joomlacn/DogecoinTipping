...
class BlockKey
{
    ...
    /***
     * returns the private key under the DOGECOINTIPPING Import Format
     *
     * @return String Base58
     * @throws \Exception
     */
    ...
    /***
     * Tests if the Wif key (DOGECOINTIPPING Import Format) is valid or not.
     *
...
//            $nonce      = gmp_strval(gmp_mod(gmp_init(hash('sha256',$random), 16), $n), 16);
     ...
     * based on https://github.com/brainDOGECOINTIPPING/brainDOGECOINTIPPING.github.io/blob/master/js/bitcoinsig.js
