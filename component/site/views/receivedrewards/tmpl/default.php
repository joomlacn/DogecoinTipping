...
?>
<div class="dogecointipping-received-rewards<?php echo $this->pageclass_sfx; ?>">
...
<form class="form-inline" action="<?php echo JRoute::_('index.php?option=com_dogecointipping&view=receivedrewards');?>" method="post" name="adminForm" id="adminForm">
...
<?php if($this->items) :?>
	<table class="table table-striped">
		<thead>
			<tr>
				<th>
					<?php echo JHtml::_('grid.sort', 'COM_DOGECOINTIPPING_HEADING_FROM_USER_NAME', 'users.name', $listDirn, $listOrder); ?>					
				</th>
				<th>
			...
			<tr <?php if($i % 2 != 0) echo 'class="pure-table-odd"'; ?>>
				<td class="center">
					<?php if(!empty($item->name)) : 
						$user_link = JRoute::_('index.php?option=com_easysocial&view=profile&id=' . $item->from_user_id . ':' . $item->username . '&Itemid=172');
					?>
