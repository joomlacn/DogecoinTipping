...
class DogecoinTippingModelReceivedRewards extends JModelList {
	...
	protected function getListQuery() {
        ...
        $query->join('LEFT', '#__users AS users ON reward.from_user_id = users.id');
        $user = JFactory::getUser();
        $query->where('reward.to_user_id = ' . $user->id);		
